...
class AllowMultiGestureRecognizer extends TapGestureRecognizer {
  @override
  ...
  Widget build(BuildContext context) {
    return TouchDetectionController(
      ...
      child: RawGestureDetector(
        ...
        gestures: {
          AllowMultiGestureRecognizer:
              GestureRecognizerFactoryWithHandlers<AllowMultiGestureRecognizer>(
            () => AllowMultiGestureRecognizer(),
            (AllowMultiGestureRecognizer instance) {
              instance
                ..onTapUp = (tapDetail) {
                  touchController.add(
                    Gesture(GestureType.onTapUp, tapDetail),
                  );
                }
                ..onTapDown = (tapDetail) {
...
class TouchDetectionController extends InheritedWidget {
  ...
  const TouchDetectionController(this._controller, this.addListener, {required Widget child})
      : super(child: child);
